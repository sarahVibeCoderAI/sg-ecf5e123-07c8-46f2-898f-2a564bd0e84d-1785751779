        ...
        <section className="py-8 lg:py-11 bg-muted/30">
          <div className="container max-w-4xl text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12 max-w-5xl mx-auto">
              <Card className="bg-card border-border hover:shadow-lg transition-shadow">
                <CardContent className="p-6 space-y-4">
                  <div className="text-center space-y-2">
                    <h3 className="font-display text-2xl font-semibold">5 Credits</h3>
                    <p className="text-3xl font-bold text-copper">₹2,250</p>
                    <p className="text-sm text-foreground/60">₹450 per credit</p>
                  </div>
                  <p className="text-sm text-foreground/70 text-center leading-relaxed">
                    Perfect for trying out the subscription or supplementing your meals a few times a week.
                  </p>
                  <Button asChild className="w-full bg-sage hover:bg-sage/90 text-white">
                    <a
                      href="https://wa.me/919008454373?text=Hey%20I'm%20interested%20in%20the%205%20credit%20pack"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Choose 5 Credits
              ...
              <Card className="bg-card border-2 border-copper hover:shadow-lg transition-shadow relative">
                <Badge className="absolute -top-3 left-1/2 -translate-x-1/2 bg-copper text-white">
                  Most Popular
                </Badge>
                <CardContent className="p-6 space-y-4">
                  <div className="text-center space-y-2">
                    <h3 className="font-display text-2xl font-semibold">10 Credits</h3>
                    <p className="text-3xl font-bold text-copper">₹4,200</p>
                    <p className="text-sm text-foreground/60">₹420 per credit</p>
                  </div>
                  <p className="text-sm text-foreground/70 text-center leading-relaxed">
                    Ideal for regular healthy eating throughout the week with flexibility to mix meals and snacks.
                  </p>
                  <Button asChild className="w-full bg-copper hover:bg-copper/90 text-white">
                    <a
                      href="https://wa.me/919008454373?text=Hey%20I'm%20interested%20in%20the%2010%20credit%20pack"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Choose 10 Credits
              ...
              <Card className="bg-card border-border hover:shadow-lg transition-shadow">
                <CardContent className="p-6 space-y-4">
                  <div className="text-center space-y-2">
                    <h3 className="font-display text-2xl font-semibold">20 Credits</h3>
                    <p className="text-3xl font-bold text-copper">₹8,000</p>
                    <p className="text-sm text-foreground/60">₹400 per credit</p>
                  </div>
                  <p className="text-sm text-foreground/70 text-center leading-relaxed">
                    Best value for daily healthy eating. Covers most meals for the month with maximum savings.
                  </p>
                  <Button asChild className="w-full bg-sage hover:bg-sage/90 text-white">
                    <a
                      href="https://wa.me/919008454373?text=Hey%20I'm%20interested%20in%20the%2020%20credit%20pack"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Choose 20 Credits
