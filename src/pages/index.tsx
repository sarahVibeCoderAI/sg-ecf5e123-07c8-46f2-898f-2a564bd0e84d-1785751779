  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        {/* Editorial Our Purpose Manifesto */}
        <section 
          className="py-16 px-6 lg:py-[140px] lg:px-[8%]"
          style={{ 
            ...
            <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 max-w-5xl mx-auto">
              ...
              <div className="lg:col-span-7">
                <p 
                  ...
                  We're surrounded by conflicting advice, wellness trends and endless trackers promising to optimise every part of our lives. We think there's a simpler way.
                </p>
              </div>
            </div>

            {/* Tier 3: The 5 Principles - Horizontal Grid */}
            <div 
              className="py-12 lg:py-16 my-16 lg:my-20"
              style={{ 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-6">
                {[
                  { num: '01', text: 'Nourishing food.' },
                  { num: '02', text: 'Movement you enjoy.' },
                  { num: '03', text: 'Time outdoors.' },
                  { num: '04', text: 'Conversations around the table.' },
                  { num: '05', text: 'A strong community.' }
                ].map((principle, index) => (
                  <div 
                    key={index}
