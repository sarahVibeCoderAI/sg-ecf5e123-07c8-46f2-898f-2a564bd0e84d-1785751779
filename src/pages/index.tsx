  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        {/* Our Purpose - Full Bleed Manifesto */}
        <section 
          className="py-16 px-6 lg:py-[110px] lg:px-[6%]"
          style={{
          ...
          <div className="max-w-5xl mx-auto text-center space-y-12">
            {/* Section Kicker */}
            <p 
              className="uppercase text-sm font-semibold tracking-[0.1em]"
              style={{ color: '#C5A394' }}>
              OUR PURPOSE
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-3 pt-8">
              {[
                ...
                <div
                  ...
                  style={{
                    backgroundColor: 'rgba(142, 148, 122, 0.2)',
                    color: '#F4EEE6',
