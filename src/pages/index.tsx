  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section 
          className="py-16 px-6 lg:py-[120px] lg:px-[8%]"
          style={{ 
          ...
          <div className="max-w-5xl mx-auto space-y-12 lg:space-y-16">
            ...
            <div className="space-y-6 max-w-3xl">
              <p 
                ...
                Healthy living has become far more complicated than it needs to be. We're surrounded by conflicting advice, wellness trends and endless products promising to optimise every part of our lives.
              </p>
              <p 
                className="leading-[1.7]"
                style={{ 
            ...
            {/* The 5 Principles - Large Vertical List */}
            <div className="space-y-8 lg:space-y-10 pt-8">
              {[
                ...
                <div key={index}>
                  <p 
                    className="font-display font-normal leading-[1.2] opacity-0 animate-fade-in"
                    style={{ 
                  ...
                  {index < 4 && (
                    <div 
                      className="mt-8 lg:mt-10 h-px"
                      style={{ 
                        backgroundColor: 'rgba(142, 148, 122, 0.3)'
                      }} 
                    />
                  )}
                </div>
