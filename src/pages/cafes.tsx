  ...
  const cafes = [
    {
      ...
      amenities: ["Indoor & Garden Seating", "Bookstore", "Thrift Store", "Sustainable Fashion"],
    ...
    },
    {
      ...
      description: "A cozy neighborhood spot perfect for morning coffees and healthy lunches.",
