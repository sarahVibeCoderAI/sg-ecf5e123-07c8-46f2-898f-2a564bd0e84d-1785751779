  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Sticky 2-Column Manifesto Section - Full Bleed */}
        <div 
        ...
        >
          <div className="px-6 py-16 lg:px-[6%] lg:py-[120px] max-w-[1400px] mx-auto">
            <div className="grid lg:grid-cols-12 gap-8 lg:gap-16">
              ...
              <div className="lg:col-span-7 space-y-8">
                <p 
                  className="leading-[1.7] transition-opacity duration-500"
                  style={{ 
                ...
                <p 
                  className="font-display italic leading-[1.7]"
                  style={{ 
                    fontSize: 'clamp(1.15rem, 1.8vw, 1.6rem)',
                    letterSpacing: '0.02em',
                    color: '#C5A394'
