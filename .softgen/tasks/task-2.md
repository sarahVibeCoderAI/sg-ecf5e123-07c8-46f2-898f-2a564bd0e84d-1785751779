...
- [ ] 3-column outlet card grid:
  ...
  - Operating hours
  - Get Directions + Order Grab & Go CTAs

## Acceptance
- /cafes page accessible via navigation
- 3 outlet cards displayed with realistic Bangalore location names
- Cards show amenities icons and delivery status clearly